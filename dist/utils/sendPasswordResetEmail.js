...
const sendPasswordResetEmail = (user, passwordResetToken) => __awaiter(void 0, void 0, void 0, function* () {
    if (process.env.NODE_ENV === "test") {
        return;
    }
    const apiKey = env_1.default.sendgridKey;
    const sendgridEmail = env_1.default.sendgridEmail;
    const url = env_1.default.remoteURL + `/reset-password/${passwordResetToken}`;
